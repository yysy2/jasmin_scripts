...
# MODE OUTPUTS
    if cube.attributes['STASH'] == 'm01s34i101':
        cube.standard_name='nucleation mode (soluble) number'

    if cube.attributes['STASH'] == 'm01s34i102':
        cube.standard_name='nucleation mode (soluble) h2so4 mmr'

    if cube.attributes['STASH'] == 'm01s34i103':
        cube.standard_name='aitken mode (soluble) number'

    if cube.attributes['STASH'] == 'm01s34i104':
        cube.standard_name='aitken mode (soluble) h2so4 mmr'

    if cube.attributes['STASH'] == 'm01s34i105':
        cube.standard_name='aitken mode (soluble) bc mmr'

    if cube.attributes['STASH'] == 'm01s34i106':
        cube.standard_name='aitken mode (soluble) oc mmr'

    if cube.attributes['STASH'] == 'm01s34i107':
        cube.standard_name='accumulation mode (soluble) number'

    if cube.attributes['STASH'] == 'm01s34i108':
        cube.standard_name='accumulation mode (soluble) h2so4 mmr'

    if cube.attributes['STASH'] == 'm01s34i109':
        cube.standard_name='accumulation mode (soluble) bc mmr'

    if cube.attributes['STASH'] == 'm01s34i110':
        cube.standard_name='accumulation mode (soluble) oc mmr'

    if cube.attributes['STASH'] == 'm01s34i111':
        cube.standard_name='accumulation mode (soluble) sea salt mmr'

    if cube.attributes['STASH'] == 'm01s34i113':
        cube.standard_name='coarse mode (soluble) number'

    if cube.attributes['STASH'] == 'm01s34i114':
        cube.standard_name='coarse mode (soluble) h2so4 mmr'

    if cube.attributes['STASH'] == 'm01s34i115':
        cube.standard_name='coarse mode (soluble) bc mmr'

    if cube.attributes['STASH'] == 'm01s34i116':
        cube.standard_name='coarse mode (soluble) oc mmr'

    if cube.attributes['STASH'] == 'm01s34i116':
        cube.standard_name='coarse mode (soluble) sea salt mmr'

    if cube.attributes['STASH'] == 'm01s34i119':
        cube.standard_name='aitken mode (insoluble) number'

    if cube.attributes['STASH'] == 'm01s34i120':
        cube.standard_name='aitken mode (insoluble) bc mmr'

    if cube.attributes['STASH'] == 'm01s34i121':
        cube.standard_name='aitken mode (insoluble) oc mmr'

    if cube.attributes['STASH'] == 'm01s34i116':
        cube.standard_name='nucleation mode (soluble) oc mmr'

    if cube.attributes['STASH'] == 'm01s34i126':
        cube.standard_name='nucleation mode (soluble) oc mmr'

    if cube.attributes['STASH'] == 'm01s34i127':
        cube.standard_name='aitken mode (soluble) ss mmr'
